...
export const CHORD_DB = {
  'C':    {v:[{n:'ロー',f:[-1,3,2,0,1,0]},{n:'バレー3F',f:[-1,3,3,5,5,3],b:3},{n:'ハイ8F',f:[8,8,10,9,8,8],b:8}]},
  'Cm':   {v:[{n:'バレー3F',f:[-1,3,5,5,4,3],b:3}]},
  'Cmaj7':{v:[{n:'ロー',f:[-1,3,2,0,0,0]},{n:'バレー3F',f:[-1,3,3,5,4,3],b:3}]},
  'CM7':{v:[{n:'ロー',f:[-1,3,2,0,0,0]},{n:'バレー3F',f:[-1,3,3,5,4,3],b:3}]},
  ...
  'Fmaj7':{v:[{n:'ロー',f:[-1,-1,3,2,1,0]},{n:'バレー1F',f:[1,3,3,2,1,0]}]},
  'FM7':{v:[{n:'ロー',f:[-1,-1,3,2,1,0]},{n:'バレー1F',f:[1,3,3,2,1,0]}]},
  ...
  'BM7':{v:[{n:'バレー2F',f:[-1,2,4,3,4,2],b:2}]},
  ...
  'Db':   {v:[{n:'バレー4F',f:[-1,6,4,6,6,4],b:4}]},
  'D#':   {v:[{n:'バレー6F',f:[-1,6,6,8,8,6],b:6}]},
  'D#m':  {v:[{n:'バレー6F',f:[-1,4,6,8,7,6],b:6}]},
  'Eb':   {v:[{n:'バレー6F',f:[-1,6,5,7,7,5],b:5}]},
  'Ebm':  {v:[{n:'バレー6F',f:[-1,6,6,8,7,6],b:6}]},
  'Ebmaj7':{v:[{n:'バレー6F',f:[-1,6,5,7,6,5],b:5}]},
